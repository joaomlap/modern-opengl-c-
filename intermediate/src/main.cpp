...
// Textures
const char* brickTextureLocation = "assets/brick.png";
const char* dirtTextureLocation = "assets/dirt.png";
...
void createObjects() {
  ...
  GLfloat vertices[] = {
    // (first 3 values) - textures u & v values (next 2 values)
    // indice 0
...
int main() {
  ...
  brickTexture = Texture(brickTextureLocation);
  brickTexture.loadTexture();
  dirtTexture = Texture(dirtTextureLocation);
